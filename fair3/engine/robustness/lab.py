...
class RobustnessConfig:
    """Configuration for the robustness laboratory."""
...
class RobustnessArtifacts:
    """Paths generated by :func:`run_robustness_lab`."""
...
def _render_pdf(
    ...
    *,
    ...
    ax0.axvline(gates.max_drawdown_threshold, color="#c43c00", linestyle="--", label="Threshold")
    ax0.set_title("Bootstrap Max Drawdowns")
    ...
    ax1.set_title("Scenario Replay Drawdowns")
    ax1.set_ylabel("Max Drawdown")
    ax1.tick_params(axis="x", rotation=20)

    summary = (
        f"Exceedance prob: {gates.exceedance_probability:.3f}\n"
        f"CAGR lower bound: {gates.cagr_lower_bound:.3%}\n"
        f"Passes gates: {gates.passes()}"
    )
...
def run_robustness_lab(
    ...
    *,
    ...
    """Execute bootstrap, scenario, and ablation diagnostics."""
